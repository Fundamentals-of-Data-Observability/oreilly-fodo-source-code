...
# checking if there is any changes in the current git cloned
if git_repo.is_dirty():
    # if the code is dirty with flag the version and overwrite the commit author with the current user
...
# make classes JSON serializable: https://stackoverflow.com/a/38764817/193246
